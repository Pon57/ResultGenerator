...
class SmashggAPI
{
	...
	*/
    ...
    public function getTournament(string $tournament_slug, string $event_slug = "", array $params = []): string
    {
 //$params=['event', 'phase', 'groups', 'stations']
        if ($event_slug != "") {
    ...
    public function getEvent(int $event_id, array $params = []): string
    {
 //not slug, $params=['phase', 'groups']
        return $this->makeCall('event/'.$event_id, $params);
    }

    public function getPhase(int $phase_id, array $params = []): string
    {
 //not slug, $params=['groups']
        return $this->makeCall('phase/'.$phase_id, $params);
    }

    public function getPhaseGroup(int $phase_group_id, array $params = []): string
    {
 //not slug, $params=['sets', 'entrants', 'standings', 'seeds']
